...
COLOR_BARRA_SUPERIOR = "#161f28"
COLOR_MENU_LATERAL = "#161f28"
COLOR_CUERPO_PRINCIPAL = "#273d4e"
COLOR_MENU_CURSOR_ENCIMA = "#34677f"

class mainchat(tk.Tk):

    def __init__(self):
        super().__init__()
        self.logo = util_img.leer_imagen("./imagenes/a.png", (560, 136))
        self.config_window()
        self.paneles()
    ...
    def controles_barra_superior(self):
        ...
        # Etiqueta de título
        self.labelTitulo = tk.Label(self.barra_superior, text="Rosse AI")
        ...
        self.labelTitulo = tk.Label(
            self.barra_superior, text="fulanito@gmail.com")
        self.labelTitulo.config(fg="#fff", font=(
