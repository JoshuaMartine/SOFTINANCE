...
# root.iconbitmap("a.ico")  # Cambiado para evitar errores de icono
...
# Cargar imagen
imagen_pil = Image.open("a.png").resize((200, 200), Image.LANCZOS)  # Redimensionar la imagen
...
rose_pil = Image.open("rose.png").resize((200, 200), Image.LANCZOS)  # Redimensionar la imagen
